-- Record automatic order plan-fact synchronization in audit history.
-- The order remains derived from the latest technological operation; this
-- migration adds traceability without changing the derivation rule.
...
'Authoritative MES order plan-fact synchronization from the latest technological operation with audit trail.';
