...
function state(): MesState {
  ...
  return {
    ...
    orders: [{ id: 'O-1', number: 'O-1', productId: 'P-1', quantity: 10, completedQuantity: 0, dueAt: '2026-09-09T08:00:00.000Z', priority: 'NORMAL', status: 'IN_EXECUTION', route: [{ id: 'OP-1', sequence: 10, code: 'OP', name: 'Операция', workCenter: 'WC', setupMinutes: 0, runMinutesPerUnit: 1 }] }],
