...
const MAP: Record<string,[string,string][]> = {
  ...
  MASTER:[['Обзор','.mes-dashboard-page'],['Работа','.production-entry-page'],['Заказы','.orders-page'],['Gantt','.dispatch-gantt-page'],['Оборудование','.equipment-operations-page'],['ОТК','.quality-page']],
  DISPATCHER:[['Обзор','.mes-dashboard-page'],['Заказы','.orders-page'],['Gantt','.dispatch-gantt-page'],['Работа','.production-entry-page'],['Оборудование','.equipment-operations-page'],['ОТК','.quality-page']],
  PLANNER:[['Обзор','.mes-dashboard-page'],['Заказы','.orders-page'],['Gantt','.dispatch-gantt-page']],
  ...
  PRODUCTION_MANAGER:[['Обзор','.mes-dashboard-page'],['Заказы','.orders-page'],['Gantt','.dispatch-gantt-page'],['Работа','.production-entry-page'],['Оборудование','.equipment-operations-page'],['ОТК','.quality-page'],['События','.event-journal-page']],
  ADMIN:[['Обзор','.mes-dashboard-page'],['Заказы','.orders-page'],['Gantt','.dispatch-gantt-page'],['Работа','.production-entry-page'],['Оборудование','.equipment-operations-page'],['ОТК','.quality-page'],['События','.event-journal-page'],['Контроль','.integrity-page']]
};
