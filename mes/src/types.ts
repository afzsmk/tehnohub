...
export interface ProductionEvent { id:string; taskId?:string; type:'TASK_STARTED'|'TASK_PAUSED'|'TASK_RESUMED'|'TASK_COMPLETED'|'RESULT_RECORDED'|'DOWNTIME_STARTED'|'DOWNTIME_ENDED'|'MAINTENANCE_STARTED'|'MAINTENANCE_COMPLETED'; occurredAt:string; actorId:string; payload:Record<string,unknown>; }
