...
export interface MesQualityRpc {
  ...
  submitQualityInspection(taskId: string, status: 'APPROVED'|'REJECTED', goodQuantity: number, scrapQuantity: number, defectCode?: string, comment?: string, inspectedAt?: string, idempotencyKey?: string): Promise<QualityInspection>;
}
